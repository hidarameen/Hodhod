...
2. تلخيص النص بشكل موجز ودقيق
3. الحفاظ على الحياد والموضوعية
4. استخدام صياغة رسمية ومهنية

📊 منهجية التحليل:
• حلل النص كلمة بكلمة لفهم السياق الكامل
• حدد الكيانات والأشخاص والمنظمات المذكورة
• افهم العلاقات بين الكيانات في النص
• طبق قواعد الاستبدال على جميع الإشارات للكيانات المحددة"""
